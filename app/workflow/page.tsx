...
const STEPS: Step[] = [
  {
    ...
    description: 'Paste your website URL and any social pages (LinkedIn, Twitter/X, Crunchbase, etc.). The AI scrapes all of them, builds your company profile, and saves your preferences automatically.',
    aiActions: ['Reads your website + all linked social pages', 'Extracts company name, profile & focus areas', 'Saves your search preferences automatically'],
    humanActions: ['Paste your website URL', 'Optionally add LinkedIn, Twitter, or other pages', 'AI handles the rest'],
  ...
  },
  {
    ...
    description: '"Under Review" events appear on the dashboard with their estimated total budget displayed so you can make the call at a glance. One click converts an approved event into a full record.',
    aiActions: ['Shows estimated total budget on the dashboard card', 'Generates benchmark budget estimate', 'Creates a starter task checklist', 'Suggests relevant vendors'],
    humanActions: ['Review the opportunity + budget estimate', 'Approve or decline', 'Confirm to create the event'],
  ...
  },
  {
    ...
    description: 'After the event, get your results in any way that\'s easiest — drag and drop a file, paste a link to a doc or Notion page, or just type your notes. AI reads it and fills in the numbers automatically.',
    aiActions: ['Reads files, links, or pasted notes', 'Extracts leads, pipeline, revenue, satisfaction', 'Lets you review before saving'],
    humanActions: ['Drop a file, paste a link, or type notes', 'Review extracted numbers', 'Confirm or adjust'],
