...
const STEPS: Step[] = [
  {
    ...
    description: 'Paste your website URL. The AI reads your site, extracts your company profile, and saves your preferences automatically — no form to fill in.',
    aiActions: ['Reads your website', 'Extracts company name, profile & focus areas', 'Saves your search preferences automatically'],
    humanActions: ['Paste your website URL', 'That\'s it — AI handles the rest'],
